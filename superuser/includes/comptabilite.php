<nav class="navbar py-0 navbar-expand-md bg-info navbar-light">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="#">Les entrees</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="#">Les sortis</a>
      </li>
      <li class="nav-item">
    ...
    <div class="col-md-5 col-sm-12">
        <div class="card card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <button type="submit" name="journale" class="btn btn-block btn-info">Execute</button>
                </div>
            </form>
        </div>
